...
const PipelineTicket = ({
  ...
  ticket,
   ...
   const handleClickEdit = async () => {
     setOpen(
       <CustomModal
         title="Atualizar detalhes do Ingresso"
         subheading=""
       >
         <TicketForm
   ...
   const handleDeleteTicket = async () => {
     try {
       ...
       toast({
         title: 'Excluído',
         description: 'Ticket excluído da Pista.',
       })
 
       await saveActivityLogsNotification({
         agencyId: undefined,
         description: `Exclui um Ingresso | ${response?.name}`,
         subAccountId: subAccountId,
       })
      ...
      {(provided, snapshot) => {
        ...
        return (
          ...
          >
            <AlertDialog>
              <DropdownMenu>
                <Card className="my-4 dark:bg-slate-900 bg-white shadown-none transition-all">
                  <CardHeader className="p-[12px]">
                    ...
                    <HoverCard>
                      <HoverCardTrigger asChild>
                        <div className="p-2 text-muted-foreground flex gap-2 hover:bg-mutes transition-all rounded-lg cursor-pointer items-center">
                          <LinkIcon />
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    o ingresso e removê-lo de nossos servidores.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
