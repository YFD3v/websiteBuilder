...
export const pricingCards = [
  {
    ...
    price: "Grátis",
    duration: "",
    highlight: "Características principais",
    features: ["3 Sub accounts", "2 membros de time", "Pipelines ilimitados"],
    priceId: "",
  },
  {
    title: "Saas Ilimitado",
    description: "O melhor kit de agência",
    price: "R$199",
    duration: "mensal",
    highlight: "Características principais",
    features: ["Refaturamento", "Time de suporte 24/7"],
    priceId: "price_1PQaBeJbY20Qi3DjU6xAanK0",
  },
  {
    title: "Básico",
    ...
    price: "R$49",
    duration: "mensal",
    highlight: "Tudo do iniciante, mais",
    features: ["Sub accounts ilimitadas", "Membros de time ilimitados"],
    priceId: "price_1PQaBeJbY20Qi3DjksHjJSQG",
  },
];
export const addOnProducts = [
  { title: 'Suporte Prioritário', id: 'prod_QH8brWnth88VOS' },
]
